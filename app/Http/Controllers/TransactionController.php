...
class TransactionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.app.transaction.index', compact('transactions'));
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.app.transaction.show', compact('transaction'));
    }
    ...
    public function destroy($id)
    {
        ...
        return back()->with(['success' => 'Berhasil Hapus Transaksi']);
    }
